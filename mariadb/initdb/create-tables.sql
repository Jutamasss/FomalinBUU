...
--
-- Dumping data for table `dcs_checkin`
--

INSERT INTO `dcs_checkin` (`che_id`, `che_status`, `che_date_time_in`, `che_date_time_out`, `che_tus_id`, `che_eve_id`) VALUES
(1,	2,	'2022-02-12 16:17:46',	'2022-02-12 16:18:00',	2,	10),
(2,	2,	'2022-02-11 16:19:42',	'2022-02-11 16:19:00',	2,	8),
(3,	2,	'2022-02-15 16:20:22',	'2022-02-15 16:20:00',	2,	10),
(4,	2,	'2022-02-15 16:17:46',	'2022-02-15 16:18:00',	2,	10),
(5,	2,	'2022-02-14 16:19:42',	'2022-02-14 16:19:00',	2,	8),
(6,	2,	'2022-02-15 16:20:22',	'2022-02-15 16:20:00',	2,	10),
(7,	2,	'2022-02-12 16:20:22',	'2022-02-12 16:20:00',	2,	10),
(8,	2,	'2022-02-15 16:20:22',	'2022-02-15 16:20:00',	2,	10),
(9,	2,	'2022-02-18 13:06:59',	'2022-02-18 13:07:00',	1,	10),
(10,	2,	'2022-02-18 13:08:07',	'2022-02-18 13:08:00',	1,	9),
(11,	2,	'2022-02-18 13:34:15',	'2022-02-18 13:34:00',	1,	11),
(13,	2,	'2022-02-19 02:36:01',	'2022-02-19 02:36:00',	1,	13),
(14,	2,	'2022-02-19 03:44:28',	'2022-02-19 03:44:00',	1,	16);

-- --------------------------------------------------------


--
-- Table structure for table `dcs_sector`
--

CREATE TABLE IF NOT EXISTS `dcs_sector` (
  `sec_id` int(10) NOT NULL COMMENT 'ไอดีของระดับภาค',
  `sec_name` varchar(100) NOT NULL COMMENT 'ชื่อของระดับภาค'
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `dcs_sector`
--

INSERT INTO `dcs_sector` (`sec_id`, `sec_name`) VALUES
(1, 'ภาคเหนือ'),
(2, 'ภาคกลาง'),
...
--
-- Table structure for table `dcs_province`
--

CREATE TABLE IF NOT EXISTS `dcs_province` (
  `prv_id` int(10) NOT NULL COMMENT 'ไอดีของจังหวัด',
  `prv_code` varchar(2) NOT NULL COMMENT 'รหัสของจังหวัด',
  `prv_name_th` varchar(150) NOT NULL COMMENT 'ชื่อไทยของจังหวัด',
  `prv_name_en` varchar(150) NOT NULL COMMENT 'ชื่ออังกฤษของจังหวัด',
  `prv_sec_id` int(10) NOT NULL DEFAULT '0' COMMENT 'ไอดีของระดับภาค จากตาราง dcs_sector'
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `dcs_province`
--

INSERT INTO `dcs_province` (`prv_id`, `prv_code`, `prv_name_th`, `prv_name_en`, `prv_sec_id`) VALUES
...
--
-- Table structure for table `dcs_district`
--

CREATE TABLE IF NOT EXISTS `dcs_district` (
  `dis_id` int(10) NOT NULL COMMENT 'ไอดีของอำเภอ',
  `dis_code` varchar(4) NOT NULL COMMENT 'รหัสของอำเภอ',
  `dis_name_th` varchar(150) NOT NULL COMMENT 'ชื่อไทยของอำเภอ',
  `dis_name_en` varchar(150) NOT NULL COMMENT 'ชื่ออังกฤษของอำเภอ',
  `dis_prv_id` int(10) NOT NULL DEFAULT '0' COMMENT 'ไอดีของจังหวัด จากตาราง dcs_province'
) ENGINE=InnoDB AUTO_INCREMENT=1007 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


--
-- Dumping data for table `dcs_district`
--

INSERT INTO `dcs_district` (`dis_id`, `dis_code`, `dis_name_th`, `dis_name_en`, `dis_prv_id`) VALUES
...
--
-- Table structure for table `dcs_parish`
--

CREATE TABLE IF NOT EXISTS `dcs_parish` (
  `par_id` int(10) NOT NULL PRIMARY KEY AUTO_INCREMENT COMMENT 'ไอดีของตำบล',
  `par_zip` varchar(6) NOT NULL COMMENT 'รหัสของตำบล',
  `par_code` int(11) NOT NULL COMMENT 'รหัสไปรษณีย์ของตำบล',
  `par_name_th` varchar(150) NOT NULL COMMENT 'ชื่อไทยของตำบล',
  `par_name_en` varchar(150) NOT NULL COMMENT 'ชื่ออังกฤษของตำบล',
  `par_dis_id` int(10) NOT NULL DEFAULT '0' COMMENT 'ไอดีของอำเภอ จากตาราง dcs_district'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `dcs_parish`
--

INSERT INTO `dcs_parish` (`par_zip`, `par_code`, `par_name_th`, `par_name_en`, `par_dis_id`) VALUES
...
CREATE TABLE `dcs_company` (
  ...
  `com_ent_id` int(10) DEFAULT NULL COMMENT 'ไอดีของผู้ประกอบการ จากตาราง dcs_entrepreneur',
  ...
  `com_par_id` int(10) NOT NULL COMMENT 'ไอดีของตำบล จากตาราง dcs_parish'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
('620bd06a8f7f89.82446371.jpg',	'c9996b79-225f-4da6-9322-34f17b345e4c.jpg',	3),
('620d15f28be950.82030650.png',	'เอกสารยืนยัน.png',	4),
('620d16d62633e3.52925955.png',	'เอกสารยืนยัน.png',	5),
('620d1a0bb125c1.42653120.png',	'เอกสารยืนยัน.png',	6),
('620d2659a88883.72891923.png',	'เอกสารยืนยัน.png',	7),
('620d26f68ad3e7.13530231.png',	'เอกสารยืนยัน.png',	8),
('620faeae48c4d5.61097613.png',	'เอกสารยืนยัน.png',	24),
('6210682c193687.23852701.png',	'เอกสารยืนยัน.png',	26);
...
(1,	'ณเอก',	'ปุณย์ปริชญ์',	'Entrepreneur1',	'756b6dda5f9669f0277e9fb50c279a59',	'2001-07-17',	'095-557-2662',	'1-2033-12345-12-3',	'62160082@go.buu.ac.th',	2,	1,	'2022-02-06 18:08:01'),
(2,	'อัจฉราภรณ์',	'พรพัฒนทรัพย์',	'Entrepreneur2',	'7234dd6b492025d8de1778359aafc87d',	'2001-02-14',	'099-158-4644',	'1-2499-00858-89-5',	'62160344@gmail.com',	2,	1,	'2022-02-04 18:08:01'),
(3,	'ปริญญารัตน์',	'อัณณา',	'uiceuice',	'4a783eab326bf14b5d0f77ef7bf3012a',	'2006-11-23',	'082-809-1667',	'1-2503-69854-7-52',	'62160156@go.buu.ac.th',	2,	3,	'2022-02-15 16:10:57'),
(4,	'ธนิสร',	'ธรรมสวนิต',	'Tanisorn',	'2354a30e9a5641b85fb169b085fb0334',	'2000-08-14',	'095-570-1308',	'1-2001-01912-9-74',	'62160088@go.buu.ac.th',	2,	1,	'2022-02-05 15:19:51'),
(5,	'วีรเดช',	'นพสมบูรณ์',	'Weradet',	'f3ade6dfaa49b221b2de3b5a6593a898',	'2000-03-07',	'085-281-2191',	'1-2001-01912-9-75',	'62160110@go.buu.ac.th',	2,	1,	'2022-02-16 15:23:05'),
(6,	'สุทัตตาา',	'แย้มวารี',	'Sutatta',	'ce15a3abcf915be2b1dfae6b59c125d1',	'2000-04-27',	'0905540622',	'1-2001-01912-9-76',	'62160163@go.buu.ac.th',	2,	1,	'2022-02-07 15:37:26'),
(7,	'ฐานิศวรร์',	'ชัญญากรณัฐ',	'Thanisaworn',	'3612918e4bff1c9f51a29bff49fe552d',	'1992-03-11',	'090-554-0687',	'1-2001-01912-9-79',	'62160340@go.buu.ac.th',	1,	1,	'2022-02-12 16:29:49'),
(8,	'กานต์พิชชา',	'ไวชญานีก์',	'Kanpichcha',	'0bf5bff1c742ea2cce45d5cc580a0583',	'1977-02-06',	'090-554-1234',	'1-2001-01912-4-58',	'62160349@go.buu.ac.th',	1,	3,	'2022-02-12 16:32:11'),
(9,	'ณเดก',	'ปุณย์ปริชญ์',	'Entrepreneur3',	'756b6dda5f9669f0277e9fb50c279a59',	'2001-07-17',	'095-557-2662',	'1-2033-12345-12-3',	'62160098@go.buu.ac.th',	2,	1,	'2022-02-06 18:08:01'),
(10,	'อัจฉราพร',	'พรพัฒนทรัพย์',	'Entrepreneur4',	'7234dd6b492025d8de1778359aafc87d',	'2001-02-14',	'099-158-4644',	'1-2499-00858-89-5',	'62160987@gmail.com',	2,	1,	'2022-02-04 18:08:01'),
(11,	'รัตนา',	'อัณณา',	'uiceuice6',	'4a783eab326bf14b5d0f77ef7bf3012a',	'2006-11-23',	'082-809-1667',	'1-2503-69854-7-52',	'621601987@go.buu.ac.th',	2,	3,	'2022-02-15 16:10:57'),
(12,	'ธนิษา',	'ธรรมสวนิต',	'Tanisorn3',	'2354a30e9a5641b85fb169b085fb0334',	'2000-08-14',	'095-570-1308',	'1-2001-01912-9-74',	'62160764@go.buu.ac.th',	2,	2,	'2022-02-16 15:19:51'),
(13,	'วีรเนตร',	'นพสมบูรณ์',	'Weradet1',	'f3ade6dfaa49b221b2de3b5a6593a898',	'2000-03-07',	'085-281-2191',	'1-2001-01912-9-75',	'62160110@go.buu.ac.th',	2,	2,	'2022-02-16 15:23:05'),
(14,	'สุทาตัต',	'แย้มวารี',	'Sutatta4',	'ce15a3abcf915be2b1dfae6b59c125d1',	'2000-04-27',	'0905540622',	'1-2001-01912-9-76',	'62160543@go.buu.ac.th',	2,	1,	'2022-02-07 15:37:26'),
(15,	'ฐานิ',	'ชัญญา',	'Thani1',	'3612918e4bff1c9f51a29bff49fe552d',	'1992-03-11',	'090-554-0687',	'1-2001-01912-9-79',	'621603443@go.buu.ac.th',	1,	1,	'2022-02-13 16:29:49'),
(16,	'กานต์',	'ไวชญา',	'Kanass1',	'0bf5bff1c742ea2cce45d5cc580a0583',	'1977-02-06',	'090-554-1234',	'1-2001-01912-4-58',	'62160349@go.buu.ac.th',	1,	3,	'2022-02-11 16:32:11'),
(24,	'สุวพัฒน์',	'เสาวรส',	'SuwapatSao',	'04b4a078cb2d097f2350f2337d4a777b',	'1967-04-05',	'090-554-0785',	'1-2001-01912-9-73',	'621603653@go.buu.ac.th',	1,	1,	'2022-02-18 14:36:00'),
(26,	'กิตติพศ',	'รุ่งเรื่องกิจ',	'Kititpod1234',	'816a3083fbff3d2652929f55f03ce96c',	'1980-04-05',	'097-412-5435',	'1-2001-01912-9-71',	'62160652@go.buu.ac.th',	1,	1,	'2022-02-19 03:47:20');
...
CREATE TABLE `dcs_event` (
  ...
  `eve_par_id` int(10) NOT NULL COMMENT 'ไอดีของตำบล จากตาราง dcs_parish',
  `eve_adm_id` int(10) DEFAULT NULL COMMENT 'ไอดีของผู้ดูแลระบบ จากตาราง dcs_admin'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `dcs_event` (`eve_id`, `eve_name`, `eve_point`, `eve_num_visitor`, `eve_description`, `eve_status`, `eve_add_date`, `eve_start_date`, `eve_end_date`, `eve_location`, `eve_lat`, `eve_lon`, `eve_com_id`, `eve_cat_id`, `eve_par_id`, `eve_adm_id`) VALUES
(1,	'ขี่ช้าง',	5,	0,	'ขี่ช้างชมธรรมชาติ กิจกรรมสนุกๆ ที่ปราสาทสัจธรรม พัทยา\r\n“พิพิธภัณฑ์ปราสาทสัจธรรม  นำสันติสุขสู่โลก โดยใช้ศิลปะเป็นสื่อ” “ครั้งหนึ่งในชีวิต ที่ต้องมาสัมผัส” พิพิธภัณฑ์ปราสาทสัจธรรม สถานที่ท่องเที่ยวที่ไม่ไกลจากกรุงเทพ ใครอยากเที่ยวฟินๆ ตามเก็บจุดเช็คอินสุดเก๋ กับมนต์เสน่ห์ของเมืองพัทยา หาจุดถ่ายรูปบรรยากาศสวยๆ บอกเลยว่า มาที่นี่ได้ครบทุกรสแน่นอน ขอให้เชื่อมั่น มั่นใจ ในมาตรฐานการบริการที่มีความปลอดภัยด้านสุขอนามัย ในการควบคุมโรคโควิด-19 ซึ่งได้รับการรับรอง จากกระทรวงสาธารณสุข และกระทรวงการท่องเที่ยวและกีฬา\r\n\"Sanctuary of Truth Museum - a place for extraordinary photography.\"A must-visit place to see and behold once in a lifetime.\"Sanctuary of Truth Museum is an attraction a few distances from  Bangkok for those who want to travel to the best check-in point and charm of Pattaya. A striking photo spot to take photos with a beautiful ambience. Indeed, a fantastic place to see that everyone can look forward to.\r\nPlease be assured and have trust with the standard of service that the place is safe and secure. Accordingly and, certified by the Ministry of Health and the Ministry of Tourism and Sports to control the COVID-19. ',	1,	'2021-10-25 18:11:19',	'2022-02-16',	'2022-02-18',	'151/1 ม.1 ต.หนองชาก อ.บ้านบึง จ.ชลบุรี',	13.265933,	101.178009,	1,	2,	5,	NULL),
(2,	'ดำน้ำปลูกปะการัง',	20,	0,	'หยิบบิกินี่ใส่กระเป๋า แล้วไปดำน้ำ ดูปะการัง ที่ อ่าวแสมสาร อ.สัตหีบ จ.ชลบุรี กันเถอะ ด้วยความที่อยู่ใกล้กรุงเทพฯ เพียง 2 ชม. จึงสะดวกต่อการเดินทาง จะเลือกขับรถมาเองก็ชิลล์ หรือขึ้นรถตู้ จากสายใต้ เอกมัย หมอชิต ก็มีบริการค่ะ\r\nต้องขอเกริ่นก่อนว่า นี่ไม่ใช่เกาะแสมสาร และ เกาะขาม อย่างที่หลายๆ คนเข้าใจ … อ่าวแสมสาร เป็นหนึ่งในเขตความดูแลของกองทัพเรือสัตหีบ จังหวัดชลบุรี เพื่ออนุรักษ์ทรัพยากรธรรมชาติบนเกาะต่างๆ ที่รายล้อมอยู่ เช่น เกาะจวง เกาะโรงโขน เกาะโรงหนัง เกาะยุ้งเกลือ ฯลฯ ซึ่งเกาะเหล่านี้ จะมีเต่าทะเลมาวางไข่อยู่เป็นประจำ จึงไม่อนุญาตให้นักท่องเที่ยวขึ้นไปเดินบนเกาะ สามารถเดินเล่นได้เฉพาะบนหาดทรายเท่านั้นการท่องเที่ยวอ่าวแสมสาร เป็นการท่องเที่ยวเชิงอนุรักษ์ บริหารจัดการโดยชาวบ้านชุมชนช่องแสมสาร ซึ่งเราได้ซื้อทริปดำน้ำจาก Ton Samaesarn เป็นแพคเกจรวมกับที่พัก พร้อมอุปกรณ์ดำน้ำ เครื่องดื่ม น้ำอัดลม แถมบริการถ่ายภาพใต้น้ำให้ฟรี! ไม่จำกัดจำนวนภาพด้วย ',	1,	'2021-10-25 18:12:44',	'2022-02-21',	'2022-12-25',	'153/2 ม.1 ต.หนองชาก อ.บ้านบึง จ.ชลบุรี',	13.266451,	101.178505,	5,	2,	7,	NULL),
(3,	'สะพานปลา หาดวอนภา',	5,	0,	'สะพานปลาหาดวอนนภา วิถึชีวิตชุมชมชาวประมงบางแสน หมู่บ้านประมงหาดวอนนภาท่ามกลางตึกคอนโด โรงแรมที่พักที่รายล้อมริมหาดบางแสน หาดวอนนภา สุดปลายหาดวอนนภา มองไกลสุดตา คุณจะเห็นสะพานปลาหาดวอนนภา สะพานที่ทอดยาวลงสู่ทะเลบางแสน บรรยากาศรอบข้างเต็มไปด้วยเรือชาวประมองที่จอดเทียบท่าเรียงรายตามแนวสะพานปลา มุมนี้ยังคงสะท้อนวิถึชุมชนชาวประมงบางแสนดั้งเดิม ที่ยังคงหลงเหลืออยู่ไม่มากนักวิถีชีวิตชาวประมงบางแสนที่ยังคงปรากฎสู่สายตานักท่องเที่ยวยามเย็มเหล่าชาวประมงจะมาทอดแหกันริมสะพานปลาหาดวอนนภา ทุกครั้งที่มีการทอดแหแผ่กว้าง เสียงโซ่ที่ปลายแหกระทบน้ำ สายตาจับจ้องไปกับเชือกที่ปลายแห ชาวประมงค่อยๆ สาวแหขึ้นมา มีแสงสะท้อนจากเกล็ดปลาสะท้อยรับแสงพระอาทิตย์ ระยิบระยับ ได้เห็นปลาตัวเป็นๆ หลากหลายชนิดจากทะเลบางแสน ไม่ว่าจะเป็น ปลากระบอก ปลาเห็ดโคน บางตัวมีขนาดใหญ่ ความยาวเท่าถังพลาสติก สร้างความตื่นตาตื่นใจให้กับนักท่องเที่ยว เรียกเสียงชัตเตอร์ไปได้ไม่น้อยเลยทีเดียว',	2,	'2021-10-25 18:14:05',	'2021-10-25',	'2022-12-25',	'155/3 ม.1 ต.หนองชาก อ.บ้านบึง จ.ชลบุรี',	13.269679,	100.922806,	3,	2,	101,	NULL),
(4,	'กิจกรรม1',	0,	0,	'รายละเอียด',	1,	'2021-10-27 16:12:05',	'2021-10-27',	'2022-12-31',	'ที่อยู่กิจกรรม1',	13.361143,	100.984673,	2,	2,	423,	NULL),
(5,	'กิจกรรม2',	0,	0,	'รายละเอียดกิจกรรม2',	1,	'2021-10-27 16:12:54',	'2021-10-27',	'2021-10-30',	'ที่อยู่กิจกรรม2',	13.361143,	100.984673,	2,	2,	132,	NULL),
(6,	'กิจกรรม3',	20,	0,	'รายละเอียดกิจกรรม3',	1,	'2021-10-27 16:13:39',	'2021-10-27',	'2021-10-30',	'ที่อยู่กิจกรรม3',	13.361143,	100.984673,	1,	2,	321,	NULL),
(7,	'ปั่นจักยานชมวิว',	30,	0,	'จักรยานถือว่าเป็นพาหนะที่เหมาะในยุคนี้ เพราะมีคุณสมบัติ 3 ส. คือ สะดวก สิ้นเปลืองน้อย และ สุขภาพดี (คุ้ม คุ้ม แต่ทุกวันนี้ในเมืองไทย ยังไม่ค่อย เห็นใครเอาปั่นจักรยานเพื่อออกกำลังกาย หรือแม้แต่การใช้เป็นพาหนะเดินทางระยะใกล้ๆ กันเลย การปั่นจักรยานมีประโยชน์ทำให้กล้ามเนื้อขา โดยเฉพาะกล้ามเนื้อต้นขาหน้าและหลังมีความแข็งแรง เป็นการยืดเส้นยืดสาย',	4,	'2022-02-15 15:43:46',	'2022-02-15',	'2022-02-19',	'แหลมราชเวช ',	12.917383,	101.003311,	1,	3,	1124,	2),
(8,	'ปลูกต้นไม้',	20,	0,	'ที่บริเวณทางลงเรือศาลเจ้าพ่อแสน ชายหาดบางแสน อำเภอเมือง จังหวัดชลบุรี นายณรงค์ชัย คุณปลื้ม นายกเทศมนตรีเมืองแสนสุข ลงพื้นที่พร้อมด้วย พนักงานกองสาธารณสุขและสิ่งแวดล้อมเทศบาลเมืองแสนสุข เจ้าหน้าที่กู้ชีพฉลามขาวและกลุ่มจิตอาสาที่สมัครกิจกรรมอาสาเก็บขยะชายหาดบางแสน ซึ่งเทศบาลเมืองแสนสุขเปิดรับสมัครไว้กว่า 100 คน ได้ร่วมกันเก็บขยะและทำความสะอาดหน้าหาดบางแสน เพื่อฟื้นฟูทรัพยากรธรรมชาติ รวมถึงได้สัมผัสและถ่ายรูปกับความสวยงามของชายหาดบางแสน ที่สวยงามกว่าเดิม หลังถูกปิดหาดเนื่องจากวิกฤติ Covid-19 พร้อมแชร์ภาพลงสื่อออนไลน์ ซึ่งชายหาดบางแสนกำลังจะเตรียมวางแผนเปิดหาดในเร็วๆ นี้ และอาจจะมีมาตรการปิดหาดทุกวันจันทร์ เพื่อให้ธรรมชาติได้พักอีกด้วย ',	2,	'2022-02-15 15:44:57',	'2022-02-15',	'2022-02-18',	'แหลมราชเวช	',	13.279599,	100.928070,	5,	2,	1124,	1),
(9,	'ปิดไฟ 20.00',	10,	0,	'1. ถอดปลั๊กไฟฟ้าทุกครั้งที่เลิกใช้งานเครื่องใช้ไฟฟ้า รู้ไหมว่าการใช้ไฟฟ้าในบ้านมีส่วนทำให้เกิดก๊าซเรือนกระจกถึง 16%\r\n2. หันมาใช้พลังงานแสงอาทิตย์ในการตากผ้าแทนการอบผ้าในเครื่องซักผ้า\r\n3. การรีดผ้า ควรรีดครั้งละมาก แทนการรีดทีละตัว เพื่อประหยัดการใช้ไฟฟ้า\r\n4. ปิดแอร์ แล้วหันมาใช้พัดลมหรือเปิดหน้าต่างให้อากาศถ่ายเทมากขึ้น    ',	2,	'2022-02-15 15:46:06',	'2022-02-18',	'2022-02-19',	'แหลมราชเวช	',	13.266553,	101.178223,	1,	1,	1124,	1),
(10,	'ใช้ถุงผ้าแทนถุงพลาสติก',	40,	0,	'ลดใช้พลาสติก โดยเลือกใช้ของที่สามารถนำมารีไซเคิลได้ เช่น กระเป๋าผ้า หรือกระติกน้ำา        ',	2,	'2022-02-15 15:47:19',	'2022-02-18',	'2022-02-19',	'4/4',	13.266553,	101.178223,	4,	4,	1534,	1),
(11,	'ปั่นจักยานบางแสน',	30,	0,	'เส้นทางท่องเที่ยวสำหรับนักปั่นจักรยาน โดยมีเส้นทางปั่นที่ “มหาวิทยาลัยบูรพา” ปั่นสูดอากาศบริสุทธิ์ รับลมเย็นๆ กับบรรยากาศร่มรื่นรอบสระมรกต บริเวณสวนนันทนาการ “หาดบางแสน” ปั่นมาชิลๆ ชมวิวทะเลสวยๆ บนเส้นทางปั่นจักรยาน Bike Lane เลียบหาดบางแสน “แหลมแท่น” อีกหนึ่งจุดชมวิวที่สวยที่สุด อีกจุดหนึ่งของบางแสน ที่นักปั่นจักรยานไม่ควรพลาด “เขาสามมุข” ออกแรงปั่นขึ้นมาบนเขาสามมุข ชมวิวบนเขาสูง เพลินกับทิวทัศน์ธรรมชาติ ที่กว้างสุดสายตาของหาดบางแสน ',	4,	'2022-02-15 15:49:39',	'2022-02-18',	'2022-02-20',	'แหลมราชเวช	',	13.266553,	101.178223,	3,	3,	1085,	1),
(12,	'ดำน้ำที่แสมสาร',	31,	0,	'จุดดำน้ำจะอยู่บริเวณทะเลรอบอ่าวแสมสาร ธรรมชาติใต้ท้องทะเลยังคงอุดมสมบูรณ์ ให้เราเพลิดเพลินไปกับแนวปะการังสวยๆ ทั้งปะการังอ่อน ปะการังแข็ง ปะการังเขากวาง และดอกไม้ทะเลหลากสี  กับฝูงปลานานาพันธุ์ เช่น ปลานีโม่ ปลานกแก้ว ปลาลายเสือ ปลากระเบนราหู และอีกมากมาย',	2,	'2022-02-16 16:00:03',	'2022-02-17',	'2022-02-19',	'หมู่บ้านแสมสาร ',	13.272942,	100.924210,	5,	3,	1173,	2),
(13,	'เตยงามชวนปลูกปะการัง',	40,	0,	'กิจกรรมสุดพิเศษในระยะเวลาจำกัด ร่วมปลูกประการังเพื่อสร้างสิ่งสวยงามให้กับท้องทะเลไทย ณ หาดเตยงาม อำเภอสัตหีบ จังหวัดชลบุรี หน่วยบัญชาการนาวิกโยธิน  ร่วมกับหน่วยบัญชาการนาวิกโยธิน ',	4,	'2022-02-16 16:09:11',	'2022-02-22',	'2022-02-23',	'หน่วยบัญชาการนาวิกโยธิน ค่ายกรมหลวงชุมพร',	13.266553,	101.178223,	2,	4,	1173,	1),
(16,	'เก็บถุงพลาสติก',	21,	0,	'ร่วมสนุกกับร้านค้าที่ร่วมรายการด้วยการเก็บขยะที่เป็นถุงพลาสติกตามหาดวอนนภามามอบให้เจ้าหน้าที่ตามจุดประจำการ ร่วมช่วยกันรักษาความสะอวดบนหาดวอนนภา ',	2,	'2022-02-19 03:36:41',	'2022-02-19',	'2022-02-22',	'186 ถนนบางแสนล่าง',	13.266553,	101.178223,	3,	2,	1085,	2);
...
CREATE TABLE `dcs_eve_category` (
  ...
  `eve_max_score` int(10) NOT NULL COMMENT 'คะแนนสูงสุด',
  `eve_min_score` int(10) NOT NULL COMMENT 'คะแนนต่ำสุด'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(4, 'การเพิ่มตัวช่วยการลดคาร์บอน 	', 1000, 49, 40);
...
('620bca278094e7.99890594.jpg',	'e877d753-76ec-4702-a376-43709e833bea.jpg',	7),
('620bca6a3c6801.67432782.jpg',	'563000005860001.jpg',	8),
('620bcab0044c77.76611111.jpg',	'image-slider-3.jpg',	9),
('620bcaeaee2092.96148859.jpg',	'download.jpg',	10),
('620d1f818628a0.33749000.jpg',	'04_Diving.jpg',	12),
('620d21974938d9.37469843.jpg',	'03_PlantCoral.jpg',	13),
('620f9ffda797a3.16378128.jpg',	'ปั่นจักยาน.jpg',	11),
('621065a7aaf3f9.29358011.jpg',	'00_KeepPlastic.jpg',	16);
...
CREATE TABLE `dcs_promotions` (
  ...
  `pro_com_id` int(10) DEFAULT NULL COMMENT 'ไอดีของสถานที่ จากตาราง dcs_company',
  `pro_cat_id` int(10) NOT NULL COMMENT 'ไอดีของประเภทโปรโมชัน หรือของรางวัล จากตาราง dcs_pro_category',
  `pro_adm_id` int(10) DEFAULT NULL COMMENT 'ไอดีของผู้ดูแลระบบ จากตาราง dcs_admin'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `dcs_promotions` (`pro_id`, `pro_name`, `pro_point`, `pro_description`, `pro_status`, `pro_add_date`, `pro_start_date`, `pro_end_date`, `pro_com_id`, `pro_cat_id`, `pro_adm_id`) VALUES
(1,	'โปรโมชัน1',	0,	'รายละเอียดโปรโมชัน1',	1,	'2021-10-27 16:07:28',	'2021-10-27',	'2022-12-31',	1,	1,	NULL),
(2,	'โปรโมชัน2',	0,	'รายละเอียดโปรโมชัน2',	1,	'2021-10-27 16:08:06',	'2021-10-27',	'2021-10-30',	1,	1,	NULL),
(3,	'ของรางวัล1',	0,	'รายละเอียดของรางวัล1',	5,	'2021-10-27 16:08:36',	'2021-10-27',	'2022-12-31',	1,	1,	NULL),
(4,	'ส่วนลดค่าเข้า 10%',	0,	'แลกส่วนลดเข้าชม 20 %',	2,	'2022-02-15 15:51:22',	'2022-02-15',	'2022-02-19',	1,	1,	1),
(5,	'แลกสมุด',	50,	'แลกรับสมุดสุดน่ารัก',	2,	'2022-02-15 15:56:06',	'2022-02-15',	'2022-02-20',	2,	2,	2),
(6,	'แลกถุงผ้ารักษ์โลก',	100,	'แลกรับถุงผ้ารักษ์โลก',	2,	'2022-02-15 16:02:11',	'2022-02-15',	'2022-02-19',	1,	2,	1),
(7,	'Boxing day sale up to 50% off!',	0,	'Boxing day sale up to 50% off! โปรโมชันลดรราคาสูงสุด 50% ไปเลย เพียงลูกค้ายื่นคูปองชิ้นนี้กับทางร้านค้าที่เข้าร่วมรายการ',	2,	'2022-02-16 09:38:47',	'2022-02-16',	'2022-03-09',	4,	1,	NULL),
(8,	'Buy 1 Get 1 FREE!',	0,	'ซื้อสินค้าขั้นต่ำ 1 ชิ้น รับเพิ่มเลยอีก 1 ชิ้น เพียงนำโปรโมชันนี้ไปใช้งานกับทางรานค้าที่ร่วมรายการ',	2,	'2022-02-16 09:44:11',	'2022-02-16',	'2022-03-31',	5,	1,	NULL),
(9,	'Final sale up to 70% off',	0,	'Final sale up to 70% off ลดล้างสต็อก ลดราคาสินค้าที่ร่วมรายการสูงสุด 70% เงื่อนไขเป็นไปตามที่สถานประกอบการกำหนด',	2,	'2022-02-16 09:48:52',	'2022-02-16',	'2022-03-31',	3,	1,	NULL),
(10,	'Buy one get one free',	0,	'โปรโมชันสุดพิเศษ ซื้อสินค้าชิ้นเดียวรับเพิ่มไปเลยอีก 1 ชิ้น สำหรับสินค้าที่ร่วมรายการเท่านั้น',	2,	'2022-02-16 09:57:17',	'2022-02-16',	'2022-03-31',	2,	1,	NULL),
(11,	'GIFT VOUCHER',	0,	'คูปองส่วนลด 120THB สำหรับสินค้าที่ร่วมรายการ และร้านค้าที่เข้าร่วมโครงการ',	2,	'2022-02-16 10:02:19',	'2022-02-16',	'2022-03-31',	4,	1,	NULL),
(12,	'แลกตุ๊กตาโลมาสุดน่ารัก',	150,	'ตุ๊กตาโลมาสุดน่ารัก พร้อมให้เเลกเเล้ววันนี้ ขนนุ่มสวยสัมผัสเเล้วมีความสุข',	2,	'2022-02-16 16:15:33',	'2022-02-16',	'2022-02-20',	3,	2,	1),
(13,	'ส่วนลดค่าอาหาร 10%',	0,	'เฉพาะผู้ที่จองห้องพักรับส่วนลดค่าอาหาร 10% เมื่อทานอาหารที่ เดอะ มารีน่า ซีวิว บางแสน โฮเทล\r\n',	2,	'2022-02-16 16:51:14',	'2022-02-16',	'2022-02-17',	4,	1,	1),
(14,	'เครื่องดื่มเมนูเย็น 1 ฟรี 1',	0,	'เมื่อสั่งเครื่องดื่มเมนูเย็นเมนูใดก็ได้ 1 แก้ว รับฟรี!! เครื่องดื่มชนิดเดียวกันหรือราคาเท่ากัน 1 แก้ว\r\n',	2,	'2022-02-16 16:52:15',	'2022-02-16',	'2022-04-30',	4,	1,	1),
(15,	'แลกแก้วน้ำเก็บอุณหภูมิ',	150,	'แก้วน้ำเก็บอุณหภูมิ ความจุ 550 มล. มีอายุการใช้งานที่ยาวนาน ช่วยลดปริมาณขยะต่อวันและต่อปีได้ยาวนานถึง 3 – 5 ปีต่อ 1 คน',	2,	'2022-02-16 16:54:07',	'2022-02-16',	'2022-02-17',	5,	2,	1),
(19,	'กระเป๋าผ้าลดโลกร้อน',	30,	'กระเป๋าผ้าลดโลกร้อน ขนาด 31 × 25 × 5 cm ซักทำความสะอาดง่าย นำกลับมาใช้ซ้ำได้ พกพาสะดวก ทนทาน ขาดยาก ใช้งานได้ทั้งกระเป๋าหิ้ว หรือ กระเป๋าสะพาย',	2,	'2022-02-19 03:39:39',	'2022-02-19',	'2022-02-22',	3,	2,	2);
...
('620bcbf7afa5f6.14877690.jpg',	'Couple (10).jpg',	1),
...
('620cc76964f172.54705328.jpg',	'18963136.jpg',	8),
('620cc882471766.62848334.jpg',	'SL-101819-24230-06.jpg',	9),
('620cca7c772b46.65562477.jpg',	'SL-100520-36260-22.jpg',	10),
('620ccba9387ce1.67168639.jpg',	'477306-PGNS2T-165.jpg',	11),
('620d2323571ce7.87544492.webp',	'6612d360aec15d2218032e04ef2b6e0f.jpg_2200x2200q80.jpg_.webp',	12),
('620d2b8032ea30.61332940.jpg',	'promo1.jpg',	13),
('620d2bbc8eb653.40797691.jpg',	'promo2.jpg',	14),
('620d2c2d456cd3.04442070.jpg',	'reward2.jpg',	15),
('620d2c826c8957.97046540.jpg',	'promo3.jpg',	4),
('62106673751598.68620628.jpg',	'reward1.jpg',	19);
...
INSERT INTO `dcs_tourist` (`tus_id`, `tus_firstname`, `tus_lastname`, `tus_username`, `tus_password`, `tus_birthdate`, `tus_tel`, `tus_score`, `tus_email`, `tus_cur_score`, `tus_status`, `tus_pre_id`, `tus_regis_date`) VALUES
(1,	'สมชาย',	'ชาติทหาร',	'Tourist1',	'505dcb6961f3f927df15f9fec5ff7ae8',	'1986-10-21',	'090-111-1111',	13,	'62160110@go.buu.ac.th',	163,	1,	1,	'2022-02-13 21:42:29'),
(2,	'ปริญญารัตน์',	'อัณณา',	'uiceuice',	'4a783eab326bf14b5d0f77ef7bf3012a',	'2000-04-10',	'0828091667',	50,	'62160156@go.buu.ac.th',	100,	1,	3,	'2022-02-02 16:12:19'),
(3,	'นันทสิริ',	'ไข่มุก',	'nantasiri',	'3f43205d6d4ea4fbb22d72b0289d6516',	'1938-09-17',	'0989998809',	0,	'62160093@go.buu.ac.th',	0,	1,	2,	'2022-02-01 16:56:09'),
(4,	'สุวพัฒน์ ',	'เสาวรส',	'Suwapat',	'04b4a078cb2d097f2350f2337d4a777b',	'2001-04-05',	'0905540622',	0,	'62160340@go.buu.ac.th',	0,	1,	1,	'2022-02-01 15:29:00'),
(5,	'จุฑามาศ',	'ทับทอง',	'Jutamas',	'33a021f159bb1373ab13ff8bc2fc298f',	'2003-06-13',	'0905540623',	0,	'62160341@go.buu.ac.th',	0,	1,	1,	'2022-02-02 15:32:02'),
(6,	'วิรัตร',	'สากร',	'Wirat',	'ab3cceaee8b10709875d637cfa4c44cc',	'1974-03-13',	'0905540643',	0,	'62160109@go.buu.ac.th',	0,	1,	1,	'2022-02-16 15:33:31'),
(7,	'สุทัตตา',	'แย้มวารี',	'Sutatta',	'ce15a3abcf915be2b1dfae6b59c125d1',	'2001-04-27',	'0905540645',	0,	'62160163@go.buu.ac.th',	0,	1,	1,	'2022-02-02 15:34:58'),
(8,	'ธนวัตน์',	'พันธา',	'Tanawat',	'ccc90f3a8e539cbddac3a09006415197',	'1995-01-13',	'0905540646',	0,	'62160087@go.buu.ac.th',	0,	1,	1,	'2022-02-05 15:40:55'),
(9,	'สมชาย',	'ใจเยน',	'somchai',	'79d083e6c7c01baea17ff8ad7d8651f6',	'1937-10-16',	'0978654567',	0,	'nantasiri2912@gmail.com',	0,	1,	1,	'2022-02-06 15:46:22'),
(10,	'ธนวัตน์',	'พันธาา',	'Tanawat1',	'ccc90f3a8e539cbddac3a09006415197',	'1995-01-13',	'0905540646',	0,	'62160123@go.buu.ac.th',	0,	1,	1,	'2022-02-15 15:40:55'),
(11,	'สมชายย',	'ใจเยน',	'somchai1',	'79d083e6c7c01baea17ff8ad7d8651f6',	'1937-10-16',	'0978654567',	0,	'nantasiri2912@gmail.com',	0,	1,	1,	'2022-02-06 15:46:22'),
(13,	'ปริญญารัต',	'อัณณาา',	'uiceuice1',	'4a783eab326bf14b5d0f77ef7bf3012a',	'2000-04-10',	'0828091667',	50,	'62160156@go.buu.ac.th',	100,	1,	3,	'2022-02-02 16:12:19'),
(14,	'นันทสิ',	'ไข่มุกก',	'nantasiri1',	'3f43205d6d4ea4fbb22d72b0289d6516',	'1938-09-17',	'0989998809',	0,	'62160065@go.buu.ac.th',	0,	1,	2,	'2022-02-01 16:56:09'),
(15,	'สุวพัด',	'เสาวรส',	'Suwapat1',	'04b4a078cb2d097f2350f2337d4a777b',	'2001-04-05',	'0905540622',	0,	'62160340@go.buu.ac.th',	0,	1,	1,	'2022-02-01 15:29:00'),
(16,	'จุฑามารถ',	'ทับทอง',	'Jutamas1',	'33a021f159bb1373ab13ff8bc2fc298f',	'2003-06-13',	'0905540623',	0,	'62160311@go.buu.ac.th',	0,	1,	1,	'2022-02-02 15:32:02'),
(17,	'วิรัด',	'สากร',	'Wirat1',	'ab3cceaee8b10709875d637cfa4c44cc',	'1974-03-13',	'0905540643',	0,	'62160187@go.buu.ac.th',	0,	1,	1,	'2022-02-16 15:33:31'),
(18,	'สุทัต',	'แย้มวารี',	'Sutatta',	'ce15a3abcf915be2b1dfae6b59c125d1',	'2001-04-27',	'0905540645',	0,	'62160168@go.buu.ac.th',	0,	1,	3,	'2022-02-04 15:34:58'),
(19,	'TEST',	'TEST',	'TEST',	'25d55ad283aa400af464c76d713c07ad',	'1922-01-01',	'0899999999',	0,	'TEST@TEST',	0,	1,	1,	'2022-02-19 05:07:12');
-- --------------------------------------------------------
...
--
-- Dumping data for table `dcs_tourist_image`
--

INSERT INTO `dcs_tourist_image` (`tus_img_path`, `tus_img_name`, `tus_img_tus_id`) VALUES
('620bd0e3ee5ea3.56210398.jpg',	'',	2);
...
--
-- Dumping data for table `dcs_tou_promotion`
--

INSERT INTO `dcs_tou_promotion` (`tou_id`, `tou_pro_status`, `tou_pro_id`, `tou_tus_id`) VALUES
(1,	1,	5,	2),
(3,	2,	5,	1),
(4,	2,	5,	1);
...
--
-- Indexes for table `dcs_sector`
--
ALTER TABLE `dcs_sector`
  ADD PRIMARY KEY (`sec_id`);

--
-- Indexes for table `dcs_province`
--
ALTER TABLE `dcs_province`
  ADD PRIMARY KEY (`prv_id`),
  ADD KEY `prv_sec_id` (`prv_sec_id`);

--
-- Indexes for table `dcs_district`
--
ALTER TABLE `dcs_district`
  ADD PRIMARY KEY (`dis_id`),
  ADD KEY `dis_prv_id` (`dis_prv_id`);

--
-- Indexes for table `dcs_parish`
--
ALTER TABLE `dcs_parish`
  ADD KEY `par_dis_id` (`par_dis_id`);
...
ALTER TABLE `dcs_event`
  ...
  ADD KEY `eve_par_id` (`eve_par_id`),
  ADD KEY `eve_adm_id` (`eve_adm_id`);
...
--
-- Constraints for table `dcs_province`
--
ALTER TABLE `dcs_province`
  ADD CONSTRAINT `dcs_province_ibfk_1` FOREIGN KEY (`prv_sec_id`) REFERENCES `dcs_sector` (`sec_id`);

--
-- Constraints for table `dcs_district`
--
ALTER TABLE `dcs_district`
  ADD CONSTRAINT `dcs_district_ibfk_1` FOREIGN KEY (`dis_prv_id`) REFERENCES `dcs_province` (`prv_id`);

--
-- Constraints for table `dcs_parish`
--
ALTER TABLE `dcs_parish`
  ADD CONSTRAINT `dcs_parish_ibfk_1` FOREIGN KEY (`par_dis_id`) REFERENCES `dcs_district` (`dis_id`);
...
ALTER TABLE `dcs_company`
  ...
  ADD CONSTRAINT `dcs_company_ibfk_3` FOREIGN KEY (`com_par_id`) REFERENCES `dcs_parish` (`par_id`);
...
ALTER TABLE `dcs_event`
  ...
  ADD CONSTRAINT `dcs_event_ibfk_3` FOREIGN KEY (`eve_par_id`) REFERENCES `dcs_parish` (`par_id`),
  ADD CONSTRAINT `dcs_event_ibfk_4` FOREIGN KEY (`eve_adm_id`) REFERENCES `dcs_admin` (`adm_id`);
...
ALTER TABLE `dcs_promotions`
  ...
  ADD CONSTRAINT `dcs_promotions_ibfk_3` FOREIGN KEY (`pro_adm_id`) REFERENCES `dcs_admin` (`adm_id`);;
